...
[`docs/HOW_IT_WORKS.md`](../docs/HOW_IT_WORKS.md). Here is the postcard
version.
...
| Topic | Where |
|---|---|
| Every box in the pipeline | [`docs/HOW_IT_WORKS.md`](../docs/HOW_IT_WORKS.md) |
| The six scanning rules | [`docs/SCAN_SAFETY.md`](../docs/SCAN_SAFETY.md) |
| Colours & themes | [`docs/THEMING.md`](../docs/THEMING.md) |
| Hosting it yourself | [`docs/SELF_HOSTING.md`](../docs/SELF_HOSTING.md) |
